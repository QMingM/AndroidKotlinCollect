package com.android.kotlin.base.utils.statusbar
...
val statusBarHeight: Int
    get() {
        ...
        return if (resId > 0) {
            BaseApplication.context.resources.getDimensionPixelSize(resId)
        } else {
...
fun Activity.setStatusBarLightMode(): Boolean {
    ...
    val isMIUICustomStatusBar: Boolean =
        (isMIUI9ABOVE && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)
                || isMIUI9BELOW
